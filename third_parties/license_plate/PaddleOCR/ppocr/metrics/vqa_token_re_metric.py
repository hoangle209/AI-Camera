    ...
    def get_metric(self):
        ...
        for b in range(len(self.relations_list)):
            ...
            for head, tail in zip(
                self.relations_list[b]["head"], self.relations_list[b]["tail"]
            ):
                rel = {}
                rel["head_id"] = head
                rel["head"] = (
                ...
                rel["head_type"] = self.entities_list[b]["label"][rel["head_id"]]
                ...
                rel["tail_type"] = self.entities_list[b]["label"][rel["tail_id"]]
